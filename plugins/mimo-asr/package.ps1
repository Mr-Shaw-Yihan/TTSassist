...
#
# -Install 会装进 %APPDATA%/com.voiceassist.app/plugins/mimo-asr/ 并更新 registry.json。
...
$PluginId   = "mimo-asr"
$PluginName = "MiMo ASR（小米·云端）"
$Version    = "1.0.0"
$MinAppVer  = "1.5.0"
$Desc       = "小米 MiMo-V2.5-ASR 云端语音识别，支持中英文及自动语种检测"
...
$DllSrc = Join-Path $PluginDir "target\release\mimo_asr.dll"
...
if ($Install) {
    ...
    Write-Host "启动 VoiceAssist 后，ASR 插件将自动加载。"
}
